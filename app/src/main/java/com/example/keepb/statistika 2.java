...
public class statistika extends AppCompatActivity {
    ...
    public void stats(){
        ...
        float statbtv= (1-qbt)*100;
        float statbwv= (1-qbw)*100;
        float statdtv= (1-qdt)*100;
        float statdwv= (1-qdw)*100;
        float statmtv= (1-qmt)*100;
        float statmwv= (1-qmw)*100;
        float statatv= (1-qat)*100;
        float statawv= (1-qaw)*100;
        float statltv= (1-qlt)*100;
        float statlwv= (1-qlw)*100;
