...
public class UpImera extends AppCompatActivity {
    ...
    EditText imera;
    Button updateswitch,telosimerasup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        telosimerasup=findViewById(R.id.telosmerau);
        ...
        telosimerasup.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void savemeraup() {
        ...
        int sumo =(icoca.isChecked()?1:0)+(ialcoolv.isChecked()?1:0);


        if(sum==10 && iwaterv.getRating()>=2 ){
